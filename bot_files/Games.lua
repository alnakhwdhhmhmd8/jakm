...
if Redis:get(TheMero.."Mero:Game:Estimate"..msg.chat_id..(_games_uid)) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return send(msg_chat_id,msg_id,"⇜ مايمديك تخمن عدد اكبر من ( 20 ) خمن رقم ما بين ( 1 - 20 )\n","md",true)
end 
local GETNUM = Redis:get(TheMero.."Mero:Game:Estimate"..msg.chat_id..(_games_uid))
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheMero.."Mero:SADD:NUM"..msg.chat_id..(_games_uid))
...
Redis:incrby(TheMero.."Mero:SADD:NUM"..msg.chat_id..(_games_uid),1)
if tonumber(Redis:get(TheMero.."Mero:SADD:NUM"..msg.chat_id..(_games_uid))) >= 3 then
Redis:del(TheMero.."Mero:SADD:NUM"..msg.chat_id..(_games_uid))
Redis:del(TheMero.."Mero:Game:Estimate"..msg.chat_id..(_games_uid))
...
if Redis:get(TheMero.."gamebot:Set:Manager:rd"..(_games_uid)..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."gamebot:Set:Manager:rd"..(_games_uid)..":"..msg.chat_id,"true1uu")
Redis:sadd(TheMero.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم حفظ السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:Set:Manager:rdd"..(_games_uid)..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."gamebot:Set:Manager:rdd"..(_games_uid)..":"..msg.chat_id,"true1uu")
Redis:srem(TheMero.."gamebot:List:Manager", text)
return send(msg.chat_id,msg.id,'\n⇜ تم مسح السؤال')
end
end
if Redis:get(TheMero.."Add:audio:Games"..(_games_uid)..":"..msg.chat_id) == 'start' then
if msg.content.audio then  
Redis:set(TheMero.."audio:Games"..(_games_uid)..":"..msg.chat_id,msg.content.audio.audio.remote.id)  
Redis:sadd(TheMero.."audio:Games:Bot",msg.content.audio.audio.remote.id)  
Redis:set(TheMero.."Add:audio:Games"..(_games_uid)..":"..msg.chat_id,'started')
return send(msg.chat_id, msg.id,'⇜ ارسل الجواب الان ...')
end   
end
if Redis:get(TheMero.."Add:audio:Games"..(_games_uid)..":"..msg.chat_id) == 'started' then
local Id_audio = Redis:get(TheMero.."audio:Games"..(_games_uid)..":"..msg.chat_id)
Redis:set(TheMero..'Text:Games:audio'..Id_audio,text)
Redis:del(TheMero.."Add:audio:Games"..(_games_uid)..":"..msg.chat_id)
...
return send(msg_chat_id,msg_id,"\n⇜ كفو اجابتك صح \n⇜ تم اضافة لك 500 درهم 💵\n⇜ رصيدك البنكي : ".._gbal5c.." درهم 💵 \n✧","md",true) 
end
end
if Redis:get(TheMero.."mero:All:Add:audio:Games"..(_games_uid)..":"..msg.chat_id) == 'startdel' then
if not Redis:sismember(TheMero.."mero:All:text:Games:Bot",text) then
send(msg_chat_id,msg_id,'⇜ لا يوجد صوت بهذا الاسم عام')
Redis:del(TheMero.."mero:All:Add:audio:Games"..(_games_uid)..":"..msg.chat_id)
return false
end
...
if Redis:get(TheMero.."mero:All:Add:audio:Games"..(_games_uid)..":"..msg.chat_id) == 'start' then
Redis:set(TheMero..'mero:All:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(TheMero.."mero:All:text:Games:Bot",text)  
Redis:set(TheMero.."mero:All:Add:audio:Games"..(_games_uid)..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفظه باسم : '..text)
return false
end
if Redis:get(TheMero.."mero:All:Add:audio:Games"..(_games_uid)..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
...
if Redis:get(TheMero.."mero:Add:audio:Games"..(_games_uid)..":"..msg.chat_id) == 'startdel' then
...
Redis:del(TheMero.."mero:Add:audio:Games"..(_games_uid)..":"..msg.chat_id)
return false
end
...
if Redis:get(TheMero.."mero:Add:audio:Games"..(_games_uid)..":"..msg.chat_id) == 'start' then
Redis:set(TheMero..'mero:Text:Games:audio'..msg.chat_id,text)
Redis:sadd(TheMero.."mero:text:Games:Bot"..msg.chat_id,text)  
Redis:set(TheMero.."mero:Add:audio:Games"..(_games_uid)..":"..msg.chat_id,'started')
send(msg_chat_id,msg_id,'⇜ ارسل الصوت ليتم حفضه باسم : '..text)
return false
end
if Redis:get(TheMero.."mero:Add:audio:Games"..(_games_uid)..":"..msg.chat_id) == 'started' then
if msg.content.audio then  
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id) == "truedel" then
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,"truefguigf1")
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,"true1")
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true1" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as1"..quschen,text)
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,"true2")
return send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true2" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as2"..quschen,text)
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,"true3")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true3" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as3"..quschen,text)
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,"true4")
return send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الرابع') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true4" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as0"..quschen,text)
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,"true44")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الاجوبة \n⇜ ارسل الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true44" then
local quschen = Redis:get(TheMero.."gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."gamebot:newqus:as4"..quschen,text)
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,"true186")
return send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id) == "truedel" then
send(msg_chat_id,msg_id, '\n⇜ تم مسح الغز ')
Redis:set(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id,"truefguigf1")
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ اللغز \n⇜ ارسل الجواب الاول')
Redis:set(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id,"true1")
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true1" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الثاني')
local quschen = Redis:get(TheMero.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."lkz:gamebot:newqus:as1"..quschen,text)
Redis:set(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id,"true2")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true2" then
send(msg_chat_id,msg_id, '\n⇜ ارسل الجواب الثالث')
local quschen = Redis:get(TheMero.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."lkz:gamebot:newqus:as2"..quschen,text)
Redis:set(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id,"true3")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true3" then
send(msg_chat_id,msg_id, ' \n⇜ ارسل الجواب الصحيح')
local quschen = Redis:get(TheMero.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."lkz:gamebot:newqus:as3"..quschen,text)
Redis:set(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id,"true44")
return false 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id) == "true44" then
send(msg_chat_id,msg_id, '\n⇜ تم حفظ الجواب الصحيح')
local quschen = Redis:get(TheMero.."lkz:gamebot:newqus"..msg.chat_id)
Redis:set(TheMero.."lkz:gamebot:newqus:as4"..quschen,text)
Redis:set(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id,"true186")
return false 
end
end
if Redis:get(TheMero..":"..(_games_uid)..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(TheMero..":"..(_games_uid)..":lov_Bots"..msg.chat_id)
end
if Redis:get(TheMero..":"..(_games_uid)..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبة الغباء : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..(_games_uid)..":lov_Bottts"..msg.chat_id)
end
if Redis:get(TheMero..":"..(_games_uid)..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبة الذكاء : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..(_games_uid)..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(TheMero..":"..(_games_uid)..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⇜ نسبه الكره : '..text..' '..sendnum..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..(_games_uid)..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(TheMero..":"..(_games_uid)..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⇜ نسبة الرجوله : '..text..' '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..(_games_uid)..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(TheMero..":"..(_games_uid)..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '⇜ نسبه الانوثة : '..text..' '..sendnuj..'%'
send(msg_chat_id,msg_id,tttttt) 
Redis:del(TheMero..":"..(_games_uid)..":ano_Bots"..msg.chat_id)
end
...
if text == "انا" then
if Redis:sismember(TheMero..'List_Ahkamm'..msg.chat_id,(_games_uid)) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(TheMero..'members_Ahkamm'..msg.chat_id,(_games_uid))
Redis:sadd(TheMero..'List_Ahkamm'..msg.chat_id,(_games_uid))
...
if Redis:sismember(TheMero..'List_Ahkkam'..msg.chat_id,(_games_uid)) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(TheMero..'List_Ahkkam'..msg.chat_id,(_games_uid))
Redis:setex(TheMero.."Witting_StartGameh"..msg.chat_id,1400,true)
local list = Redis:smembers(TheMero..'List_Ahkkam'..msg.chat_id) 
if #list == 2 then
local UserInfo = bot.getUser((_games_uid)) or {}
local Teext = '- ['..FlterBio(UserInfo.first_name or '؟')..'](tg://user?id='..(_games_uid)..')'
local zzllzz = '⇜ عدد الاعبين : '..#list..' \n⇜ انضم للعبة \n'..Teext
for k,v in pairs(list) do
if k == 1 then
local _guv = bot.getUser(v) or {}
local Nname = _guv.first_name
local Uname = _guv.username
id = "t.me/"..Uname
...
if Redis:sismember(TheMero..'List_Koorsi'..msg.chat_id,(_games_uid)) then
return bot.sendText(msg.chat_id,msg.id,'⇜ اسمك موجود من قبل',"md",true)
end
Redis:sadd(TheMero..'List_Koorsi'..msg.chat_id,(_games_uid))
...
ballancee = Redis:get(TheMero.."boob"..(_games_uid)) or 0
...
if Redis:sismember(TheMero..'List_rhan'..msg.chat_id,(_games_uid)) then
return send(msg.chat_id,msg.id,'⇜ انت مضاف من قبل .',"md",true)
end
Redis:set(TheMero.."playerrhan"..msg.chat_id,(_games_uid))
Redis:set(TheMero.."playercoins"..msg.chat_id..(_games_uid),coniss)
Redis:sadd(TheMero..'List_rhan'..msg.chat_id,(_games_uid))
...
local ballancee = Redis:get(TheMero.."boob"..(_games_uid)) or 0
rehan = tonumber(ballancee) - tonumber(coniss)
Redis:set(TheMero.."boob"..(_games_uid) , rehan)
...
if tonumber(pts3) < 0 then Redis:set(TheMero.."Mero:Num:Add:Games"..msg.chat_id..(_games_uid), 0) end
local _rbal3 = tonumber(Redis:get(TheMero.."rrfff"..(_games_uid)) or 0)
if _rbal3 >= 300 then Redis:decrby(TheMero.."rrfff"..(_games_uid), 300) else Redis:set(TheMero.."rrfff"..(_games_uid), 0) end
StatusRt = "للاسف حظك زفت خسرت 300 درهم 💵"
elseif RtList == "-5" then
local pts5 = Redis:decrby(TheMero.."Mero:Num:Add:Games"..msg.chat_id..(_games_uid),5)
if tonumber(pts5) < 0 then Redis:set(TheMero.."Mero:Num:Add:Games"..msg.chat_id..(_games_uid), 0) end
local _rbal5 = tonumber(Redis:get(TheMero.."rrfff"..(_games_uid)) or 0)
if _rbal5 >= 500 then Redis:decrby(TheMero.."rrfff"..(_games_uid), 500) else Redis:set(TheMero.."rrfff"..(_games_uid), 0) end
StatusRt = "للاسف حظك زفت خسرت 500 درهم 💵"
elseif RtList == "=" then
...
local Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "روبي")
if not Redis:get(TheMero.."Mero:Status:repleall") then
if text == 'صباح الخير' or text == 'صباحو' or text =='صباح النور' then
if not Redis:get(TheMero.."replayallbot_off"..msg.chat_id) then
local NamecBots = {
'صباح الياسمين',
'صباح النور',
...
if text== "الابراج"  or text== "ابراج"  and not Redis:get(TheMero..'replayallbot_off'..msg.chat_id) then
return send(msg.chat_id,msg.id,"ٰ⇜ اكتب : برج + اسم برجك ")
end
if text== "تحويل الصيغ" and not Redis:get(TheMero..'replayallbot_off'..msg.chat_id) then
...
Redis:set(TheMero.."gamebot:Set:Manager:rd"..(_games_uid)..":"..msg.chat_id,true)
...
Redis:set(TheMero.."gamebot:Set:Manager:rdd"..(_games_uid)..":"..msg.chat_id,true)
...
local ban = bot.getUser((_games_uid))
...
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,true)
...
Redis:set(TheMero.."gamebot:new"..(_games_uid)..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
if Redis:get(TheMero.."Mero:Game:KatQ"..msg.chat_id) then
if text and text:lower() == Redis:get(TheMero.."Mero:Game:KatQ"..msg.chat_id):lower() then
...
if Redis:get(TheMero.."Mero:Game:TweetQ"..msg.chat_id) then
if text and text:lower() == Redis:get(TheMero.."Mero:Game:TweetQ"..msg.chat_id):lower() then
...
Redis:set(TheMero.."raeahkamm"..msg.chat_id,(_games_uid))
Redis:sadd(TheMero..'List_Ahkamm'..msg.chat_id,(_games_uid))
Redis:sadd(TheMero..'members_Ahkamm'..msg.chat_id,(_games_uid))
...
if tonumber(rarahkam) == (_games_uid) then
local list = Redis:smembers(TheMero..'List_Ahkamm'..msg.chat_id) 
if #list == 1 then 
...
Redis:set(TheMero.."raeahkkam"..msg.chat_id,(_games_uid))
Redis:sadd(TheMero..'List_Ahkkam'..msg.chat_id,(_games_uid))
...
Redis:set(TheMero.."raekoorsi"..msg.chat_id,(_games_uid))
Redis:sadd(TheMero..'List_Koorsi'..msg.chat_id,(_games_uid))
...
Redis:set(TheMero.."raesaraha"..msg.chat_id,(_games_uid))
Redis:sadd(TheMero..'List_Saraha'..msg.chat_id,(_games_uid))
...
local Name = ban.first_name and ('['..ban.first_name..'](tg://user?id='..ban.id..')') or 'لا يوجد اسم'
...
Redis:set(TheMero.."raeaktooh"..msg.chat_id,(_games_uid))
Redis:sadd(TheMero..'List_Aktooh'..msg.chat_id,(_games_uid))
...
Redis:set(TheMero.."makal:bots:set"..(_games_uid)..":"..msg.chat_id,true)
return send(msg_chat_id,msg_id,"⇜ ارسل السؤال الان ")
end
...
Redis:set(TheMero.."makal:bots:del"..(_games_uid)..":"..msg.chat_id,true)
...
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."makal:bots:del"..(_games_uid)..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."makal:bots:del"..(_games_uid)..":"..msg.chat_id,"true1uu")
Redis:srem(TheMero.."makal:bots", text)
return send(msg_chat_id,msg_id, '\n⇜ تم مسح السؤال')
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMero.."makal:bots:set"..(_games_uid)..":"..msg.chat_id) == "true" then
Redis:set(TheMero.."makal:bots:set"..(_games_uid)..":"..msg.chat_id,"true1uu")
...
Redis:setex(TheMero.."mkal:setex:" .. msg.chat_id .. ":" .. (_games_uid), 60, true) 
end
end
end
if text == ""..(Redis:get(TheMero.."makal:bots:qus"..msg.chat_id) or '').."" then
local timemkall = Redis:ttl(TheMero.."mkal:setex:" .. msg.chat_id .. ":" .. (_games_uid)) 
...
Redis:del(TheMero.."makal:bots:qus"..(_games_uid)..":"..msg.chat_id)
Redis:del(TheMero.."mkal:setex:" .. msg.chat_id .. ":" .. (_games_uid)) 
end
if text =="صراحه" then
if Redis:get(TheMero.."Mero:Status:Games:malk"..msg.chat_id) then
return false 
...
Redis:set(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id,true)
...
Redis:set(TheMero.."lkz:gamebot:new"..(_games_uid)..":"..msg.chat_id,'truedel')
return send(msg_chat_id,msg_id,"⇜ ارسل اللغز الان ")
end
...
return send(msg_chat_id,msg_id, "⇜ ابشر مسحت قائمة الكيك وعددهم ( "..numtsh.." 〗 فقط .")
...
return send(msg_chat_id,msg_id, "⇜ ابشر مسحت قائمة العسل وعددهم ( "..numtsh.." 〗 فقط .")
...
return send(msg_chat_id,msg_id, "⇜ ابشر مسحت قائمة البقر وعددهم ( "..numtsh.." 〗 فقط .")
...
return send(msg_chat_id,msg_id, "⇜ ابشر مسحت قائمة قلبي وعددهم ( "..numtsh.." 〗 فقط .")
...
return send(msg_chat_id,msg_id, "⇜ ابشر مسحت قائمة الكلاب وعددهم ( "..numtsh.." 〗 فقط .")
...
return send(msg_chat_id,msg_id, "⇜ ابشر مسحت قائمة القرود وعددهم ( "..numtsh.." 〗 فقط .")
...
return send(msg_chat_id,msg_id, "⇜ ابشر مسحت قائمة الخرفان وعددهم ( "..numtsh.." 〗 فقط .")
end
...
Redis:set(TheMero..":"..(_games_uid)..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..(_games_uid)..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..(_games_uid)..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..(_games_uid)..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '⇜ الان ارسل اسمك واسم الشخص الثاني '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..(_games_uid)..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
Redis:set(TheMero..":"..(_games_uid)..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '⇜ الان ارسل اسم الشخص '
send(msg_chat_id,msg_id,hggg) 
return false
end
...
elseif (text== "رفع بقلبي" or text== "رفع لقلبي" or text== "رفع قلبي") and msg.reply_to_message_id and not Redis:get(TheMero.."trfeh"..msg.chat_id) then    
if ChannelJoinch(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = Redis:get(TheMero..'Mero:Chat:Channel:Join:Name'..msg.chat_id), url = 't.me/'..Redis:get(TheMero..'Mero:Chat:Channel:Join'..msg.chat_id)}, },}}
return send(msg.chat_id,msg.id,'\n⇜ عليك الاشتراك في قناة البوت لاستخدام الاوامر',"md",false, false, false, false, reply_markup)
end
...
if tonumber(member_id) == tonumber((_games_uid)) or tonumber(member_id) == tonumber(TheMero) or bot.getUser(member_id).type.luatele == "userTypeBot" or Redis:get(TheMero..msg_chat_id..member_id.."mtzwga:") then 
return send(msg_chat_id,msg_id,"⇜ اسف ياحلو مو وقت زواج الحين","md")
end
if Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:") then
    local zwg_id =  Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:")
...
local reply_markup = bot.replyMarkup{
  ...
  data = {
  {
  {text = 'موافق', data = (_games_uid)..'/yes_zw/'..member_id},
  {text = 'مو موافق', data = (_games_uid)..'/no_zw/'..member_id},
  },
  }
  }
...
local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(TheMero..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) == tonumber((_games_uid)) or tonumber(Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:")) == tonumber(Message_Reply.sender_id.user_id) then
  return send(msg_chat_id,msg_id,"⇜ هييه انتو متزوجين من قبل\n✧","md")
elseif tonumber(Message_Reply.sender_id.user_id) == tonumber((_games_uid)) then
...
elseif Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:") then
  local zwg_id =  Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:")
  local zwg_info = bot.getUser(zwg_id)
...
local user_info = bot.getUser((_games_uid))
local user_tag = "["..user_info.first_name.."](tg://user?id="..(_games_uid)..")"
local reply_markup = bot.replyMarkup{
  type = 'inline',
  data = {
  {
  {text = 'موافقه', data = Message_Reply.sender_id.user_id..'/yes_z/'..(_games_uid)},
  {text = 'مو موافقه', data = Message_Reply.sender_id.user_id..'/no_z/'..(_games_uid)},
  },
  }
  }
...
if text == "زوجتي" then
  if Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:") then
    local zwga_id = Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:")
  ...
  elseif not Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:") then
...
if text == "انتي طالق" and  msg.reply_to_message_id ~= 0 then 
  local Message_Reply = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Message_Reply.sender_id.user_id) == tonumber((_games_uid)) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تطلق نفسك\n✧","md")
elseif tonumber(Message_Reply.sender_id.user_id) == tonumber(TheMero) then
  return send(msg_chat_id,msg_id,"⇜ هييه مايمديك تطلقني ياورع !\n✧","md")
elseif tonumber(Redis:get(TheMero..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) ~= tonumber((_games_uid)) or tonumber(Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:")) ~= tonumber(Message_Reply.sender_id.user_id) then
...
elseif tonumber(Redis:get(TheMero..msg_chat_id..Message_Reply.sender_id.user_id.."mtzwga:")) == tonumber((_games_uid)) or tonumber(Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:")) == tonumber(Message_Reply.sender_id.user_id) then
    ...
    Redis:del(TheMero..msg_chat_id..(_games_uid).."mtzwga:")
...
if text == "طلقني" or text == "طلقيني" then
  if not Redis:get(TheMero..msg_chat_id..(_games_uid).."mtzwga:") then 
...
keyboard.inline_keyboard = {
{
{text = 'روبـي 🪄', url = "https://t.me/FvvZv"}
},
}
...
keyboard = {}
keyboard.inline_keyboard = {{{text = '• اغنية اخرى •', callback_data = (_games_uid)..'/kanele'}}}
local msg_id = msg.id/2097152/0.5
...
Redis:set(TheMero.."Mero:Game:Estimate"..msg.chat_id..(_games_uid),Num)  
...
if Redis:get(TheMero.."Mero:Status:Games"..msg.chat_id) then
Redis:del(TheMero..":Number_Add:"..msg.chat_id..(_games_uid)) 
Redis:del(TheMero..':List_Rolet:'..msg.chat_id)  
Redis:setex(TheMero..":Start_Rolet:"..msg.chat_id..(_games_uid),3600,true)  
return send(msg_chat_id,msg_id, '⇜ حسناً لنلعب , ارسل عدد اللاعبين للروليت .',"md")
end
end
if text == 'نعم' and Redis:get(TheMero..":Witting_StartGame:"..msg.chat_id..(_games_uid)) then
...
if text and text:match("^(%d+)$") and Redis:get(TheMero..":Start_Rolet:"..msg.chat_id..(_games_uid)) then
if text == "1" then
Text = "⇜ لا استطيع بدء اللعبة بلاعب واحد فقط\n"
else
Redis:set(TheMero..":Number_Add:"..msg.chat_id..(_games_uid),text)  
Text = '⇜ يرجى ارسال يوزرات اللاعبين \n⇜ الفائز يحصل على 500 درهم 💵\n⇜ عدد الاعبين المطلوبين ( '..text..' ) لاعب \n ✧'
end
Redis:del(TheMero..":Start_Rolet:"..msg.chat_id..(_games_uid))  
return send(msg_chat_id,msg_id,Text)    
end
if text and text:match('^(@[%a%d_]+)$') and Redis:get(TheMero..":Number_Add:"..msg.chat_id..(_games_uid)) then    --// استقبال الاسماء
...
local CountAdd = Redis:get(TheMero..":Number_Add:"..msg.chat_id..(_games_uid))
local CountAll = Redis:scard(TheMero..':List_Rolet:'..msg.chat_id)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
Redis:del(TheMero..":Number_Add:"..msg.chat_id..(_games_uid)) 
Redis:setex(TheMero..":Witting_StartGame:"..msg.chat_id..(_games_uid),1400,true)  
...
{q="ما هي لغة البرمجة التي يُعدّ اسمها نوعًا من الأفاعي ؟",a="بايثون"},
...
{q="كم عدد لاعبي كرة القدم في كل فريق ؟",a="11"},
{q="ما هو أسرع حيوان في العالم ؟",a="الفهد"},
{q="كم عدد أيام شهر فبراير في السنة العادية ؟",a="28"},
{q="ما هو المعدن الأغلى في العالم ؟",a="الذهب"},
{q="كم عدد كواكب المجموعة الشمسية ؟",a="8"},
{q="ما هو أعمق بحر في العالم ؟",a="المحيط الهادئ"},
{q="من هو نبي الإسلام ؟",a="محمد"},
{q="ما هي عاصمة مصر ؟",a="القاهرة"},
{q="ما هو الحيوان الذي يُعرف بسفينة الصحراء ؟",a="الجمل"},
{q="كم عدد أشهر السنة ؟",a="12"},
{q="ما هو أكبر كوكب في المجموعة الشمسية ؟",a="المشتري"},
{q="ما هي عاصمة الإمارات ؟",a="أبوظبي"},
{q="ما هو الحيوان الأضخم في العالم ؟",a="الحوت الأزرق"},
{q="كم عدد ثواني الدقيقة ؟",a="60"},
{q="ما هو أقدم رياضة في العالم ؟",a="المصارعة"},
{q="ما هي عاصمة اليابان ؟",a="طوكيو"},
{q="من رسم لوحة الموناليزا ؟",a="ليوناردو دافنشي"},
{q="ما هو اللون الذي يمتزج فيه الأحمر والأصفر ؟",a="البرتقالي"},
{q="كم عدد دقائق الساعة ؟",a="60"},
{q="ما هي عاصمة تركيا ؟",a="أنقرة"},
{q="ما هو أطول جدار في التاريخ ؟",a="سور الصين العظيم"},
{q="ما هو الغاز الأكثر وفرة في الغلاف الجوي ؟",a="النيتروجين"},
{q="من هو مؤسس شركة مايكروسوفت ؟",a="بيل غيتس"},
{q="ما هو أصغر قارة في العالم ؟",a="أستراليا"},
{q="كم عدد الحواس الخمس ؟",a="5"},
{q="ما هو الجهاز الذي يضخ الدم في جسم الإنسان ؟",a="القلب"},
{q="ما هي عاصمة الكويت ؟",a="الكويت"},
{q="من هو مخترع الطائرة ؟",a="الأخوان رايت"},
{q="ما هو الحيوان الذي لا ينام أبداً ؟",a="الحلزون"},
{q="كم عدد قارات العالم ؟",a="7"},
{q="ما هو الفيتامين الذي تحصل عليه من الشمس ؟",a="د"},
{q="ما هي عاصمة البرازيل ؟",a="برازيليا"},
{q="ما هو أطول عظمة في الجسم ؟",a="الفخذ"},
{q="من هو مخترع التلفاز ؟",a="جون بيرد"},
{q="ما هي عاصمة روسيا ؟",a="موسكو"},
{q="كم عدد نغمات السلم الموسيقي ؟",a="7"},
{q="ما هو اللون الذي يرمز للسلام ؟",a="الأبيض"},
}
local pick = KatQs[math.random(#KatQs)]
Redis:set(TheMero.."Mero:Game:KatQ"..msg.chat_id, pick.a)
return send(msg_chat_id,msg_id,"⇜ سؤال كت 🎯\n\n❓ "..pick.q.."\n\n⇜ اسرع واحد يجاوب يكسب نقطة !","md",true)
end
end
...
if Redis:get(TheMero.."Mero:Status:Games"..msg.chat_id) then
local TweetQs = {
{q="ما هو الرياضة الأكثر شعبية في العالم ؟",a="كرة القدم"},
{q="من هو أسرع إنسان في التاريخ ؟",a="أوساين بولت"},
{q="ما هو عدد أضلاع المربع ؟",a="4"},
{q="ما هي الدولة التي اخترعت الورق ؟",a="الصين"},
{q="ما هو الكوكب المعروف بالكوكب الأحمر ؟",a="المريخ"},
{q="ما هي أكبر قارة في العالم ؟",a="آسيا"},
{q="من هو أول إنسان وطأت قدمه القمر ؟",a="نيل أرمسترونغ"},
{q="ما هو البلد الذي تقع فيه برج بيزا المائل ؟",a="إيطاليا"},
{q="ما هو الحيوان الذي يعيش أطول ؟",a="السلحفاة"},
{q="كم عدد أسنان الإنسان البالغ ؟",a="32"},
{q="ما هو العنصر الكيميائي الذي رمزه O ؟",a="الأكسجين"},
{q="ما هو أكبر محيط في العالم ؟",a="الهادئ"},
{q="ما هي لغة HTML اختصار لماذا ؟",a="لغة ترميز النص التشعبي"},
{q="ما هو عاصمة الأردن ؟",a="عمان"},
{q="ما هو أغلى طائر في العالم ؟",a="النعامة"},
{q="ما هي عاصمة إيطاليا ؟",a="روما"},
{q="ما هو الحيوان المعروف بالملك ؟",a="الأسد"},
{q="كم عدد عيون الإنسان ؟",a="2"},
{q="ما هي عاصمة ألمانيا ؟",a="برلين"},
{q="ما هي أكبر دولة في العالم مساحة ؟",a="روسيا"},
{q="ما هو اليوم الأول في الأسبوع ؟",a="الأحد"},
{q="من هو مؤسس تويتر ؟",a="جاك دورسي"},
{q="ما هي العملة الرسمية للولايات المتحدة ؟",a="الدولار"},
{q="ما هي أصغر دولة عربية مساحة ؟",a="البحرين"},
{q="كم عدد أيام الأسبوع ؟",a="7"},
{q="ما هو اللون الذي تمزج فيه الأزرق والأصفر ؟",a="الأخضر"},
{q="من هو مؤسس شركة أبل ؟",a="ستيف جوبز"},
{q="ما هي عاصمة الهند ؟",a="نيودلهي"},
{q="ما هو أقصر شهر في السنة ؟",a="فبراير"},
{q="ما هو الجزء الذي يفكر به الإنسان ؟",a="الدماغ"},
{q="من هو مخترع الإنترنت ؟",a="تيم بيرنرز لي"},
{q="ما هي عاصمة إسبانيا ؟",a="مدريد"},
{q="ما هو أكبر بلد عربي مساحة ؟",a="الجزائر"},
{q="كم عدد دقائق الساعة الواحدة ؟",a="60"},
{q="ما هو الكوكب الأبعد عن الشمس في المجموعة الشمسية ؟",a="نبتون"},
{q="ما هي عاصمة المغرب ؟",a="الرباط"},
{q="ما هو الحيوان الذي يُعطي الحليب ويبيض ؟",a="خز البط"},
{q="ما هي عاصمة كندا ؟",a="أوتاوا"},
{q="كم عدد لاعبي فريق كرة السلة ؟",a="5"},
{q="ما هو الجسم الذي يدور حول الأرض ؟",a="القمر"},
{q="ما هي أكثر لغة متحدثة في العالم ؟",a="الصينية"},
{q="من هو مؤسس شركة تسلا ؟",a="إيلون ماسك"},
{q="ما هي عاصمة أستراليا ؟",a="كانبيرا"},
{q="ما هو الماء في حالته الصلبة ؟",a="الجليد"},
{q="كم عدد ديانات السماوية ؟",a="3"},
{q="ما هي عاصمة كوريا الجنوبية ؟",a="سيول"},
{q="ما هو الحيوان الذي يتميز بخطوطه السوداء والبيضاء ؟",a="الحمار الوحشي"},
{q="كم عدد لاعبي فريق الكرة الطائرة ؟",a="6"},
{q="ما هو أطول جسر في العالم ؟",a="جسر دانيانغ كونشان"},
{q="ما هي أقدم حضارة في التاريخ ؟",a="السومرية"},
}
local pick = TweetQs[math.random(#TweetQs)]
Redis:set(TheMero.."Mero:Game:TweetQ"..msg.chat_id, pick.a)
return send(msg_chat_id,msg_id,"❓ "..pick.q,"md",true)
end
end
